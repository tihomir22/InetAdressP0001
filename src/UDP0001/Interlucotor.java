...
public class Interlucotor extends Thread {
    ...
    public Interlucotor(String nombre) {
        this.nombre = nombre;
        this.setName(nombre);
    }
    ...
    public void run() {
        if (this.getName().equalsIgnoreCase("A")) {
            this.enviarMensaje("Hola interlucotor B soy A");
            try {
                Thread.sleep(1000);
            ...
            this.enviarMensaje("Hola interlucotor A soy B");
        }
    }
    ...
    public void recibirMensaje() {
        try {
            ...
            System.out.println("Recibido " + new String(mensajeBytes));
            socket.close();
